...
public class BiomeDecorator {
	...
	// Aeyra GenWorld
	protected WorldGenMinable aeryaGen;
	protected WorldGenMinable aventurineGen;
	protected WorldGenMinable eladriteGen;
	protected WorldGenMinable amethysteGen;
	protected WorldGenMinable tourmalineGen;
	...
	public void func_180292_a(World worldIn, Random p_180292_2_, BiomeGenBase p_180292_3_, BlockPos p_180292_4_) {
		if (this.currentWorld != null) {
			...
			this.amethysteGen = new WorldGenMinable(AeryaBlocks.AMETHYSTE_ORE.getDefaultState(), 5);
            this.eladriteGen = new WorldGenMinable(AeryaBlocks.ELADRITE_ORE.getDefaultState(), 4);
            this.aventurineGen = new WorldGenMinable(AeryaBlocks.AVENTURINE_ORE.getDefaultState(), 3);
            this.aeryaGen = new WorldGenMinable(AeryaBlocks.AERYA_ORE.getDefaultState(), 2);
            this.tourmalineGen = new WorldGenMinable(AeryaBlocks.TOURMALINE_ORE.getDefaultState(), 4);
	...
	protected void generateOres() {
		...
		// Aerya - Gen 
        this.genStandardOre1(6, this.amethysteGen, 0, 16);
        this.genStandardOre1(5, this.eladriteGen, 0, 14);
        this.genStandardOre1(3, this.aventurineGen, 0, 9);
        this.genStandardOre1(2, this.aeryaGen, 0, 6);
	}
}
