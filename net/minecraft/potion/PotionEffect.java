...
public class PotionEffect {
	...
	private static final List<Integer> BAD_POTION_EFFECT_IDS = new ArrayList<Integer>();

	static {

		BAD_POTION_EFFECT_IDS.add(7);
		BAD_POTION_EFFECT_IDS.add(19);
	}
	...
	public boolean isBadPotionEffect() {
		return BAD_POTION_EFFECT_IDS.contains(potionID);
	}
