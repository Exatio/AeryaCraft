...
public class ItemArmor extends Item {
	...
	public static enum ArmorMaterial {
		...
		AERYA("AERYA", 5, "aerya", 60, new int[] { 8, 12, 8, 7 }, 10),
		AMETHYSTE("AMETHYSTE", 6, "amethyste", 38, new int[] { 7, 11, 7, 6 }, 10),
		AVENTURINE("AVENTURINE", 7, "aventurine", 50, new int[] { 6, 10, 6, 5 }, 10),
		ELADRITE("ELADRITE", 8, "eladrite", 40, new int[] { 5, 9, 5, 4 }, 10),
		TOURMALINE("TOURMALINE", 9, "tourmaline", 50, new int[] { 6, 10, 5, 6 }, 10);
