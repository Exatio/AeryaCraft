...
public final class ItemStack {
	...
	public void performBadEffects(EntityLivingBase entity) {

		if (!isInfused())
			return;

		NBTTagList tagList = this.stackTagCompound.getTagList("potion", 10);
		for (int i = 0; i < tagList.tagCount(); i++) {

			PotionEffect potionEffect = new PotionEffect(tagList.getCompoundTagAt(i).getInteger("id"),
					tagList.getCompoundTagAt(i).getInteger("duration"),
					tagList.getCompoundTagAt(i).getInteger("apmlifier"));
	...
	public boolean isInfused() {
		...
		return this.stackTagCompound.hasKey("potion", 9);
	}
	...
	public void hitEntity(EntityLivingBase entityIn, EntityPlayer playerIn) {
		...
		if (getItem().isInfusable())
			performBadEffects(entityIn);
	...
	public void addPotionEffect(PotionEffect potionEffect) {
		...
		if (!this.stackTagCompound.hasKey("potion", 9))
			this.stackTagCompound.setTag("potion", new NBTTagList());

		NBTTagList tagList = this.stackTagCompound.getTagList("potion", 10);
		NBTTagCompound tagCompound = new NBTTagCompound();
		tagCompound.setInteger("id", potionEffect.getPotionID());
		tagCompound.setInteger("duration", potionEffect.getDuration());
		tagCompound.setInteger("amplifier", potionEffect.getAmplifier());
	...
	public void setLores(List<String> lores) {
		...
		for (String lore : lores)
			nbtLore.appendTag(new NBTTagString(lore));

		NBTTagCompound display = new NBTTagCompound();
		display.setTag("Lore", nbtLore);

		this.stackTagCompound.setTag("display", display);
	}
