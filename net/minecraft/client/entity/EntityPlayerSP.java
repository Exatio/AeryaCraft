...
import fr.aeryacraft.client.gui.inventory.GuiAeryaInfuser;
...
public class EntityPlayerSP extends AbstractClientPlayer {
	...
	public void displayGui(IInteractionObject guiOwner) {
		String id = guiOwner.getGuiID();

		if ("minecraft:crafting_table".equals(id))
			this.mc.displayGuiScreen(new GuiCrafting(this.inventory, this.worldObj));
		else if ("minecraft:enchanting_table".equals(id))
			this.mc.displayGuiScreen(new GuiEnchantment(this.inventory, this.worldObj, guiOwner));
		else if ("minecraft:anvil".equals(id))
			this.mc.displayGuiScreen(new GuiRepair(this.inventory, this.worldObj));
		else if ("minecraft:aerya_infuser".equals(id))
			this.mc.displayGuiScreen(new GuiAeryaInfuser(this.inventory, this.worldObj));
	}
