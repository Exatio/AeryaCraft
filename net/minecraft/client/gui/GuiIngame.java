...
public class GuiIngame extends Gui {
	...
	private static final int MAX_ARMOR_POINT = 80;
	...
	private void func_180477_d(ScaledResolution p_180477_1_) {
		if (this.mc.func_175606_aa() instanceof EntityPlayer) {
			...
			for (var22 = 0; var22 < MAX_ARMOR_POINT; ++var22)
				if (var20 > 0) {
					
					var23 = var11 + (var22 - (var22 / 10) * 10) * 8;
					
					int yArmor = var18 - (var22 / 10) * 9;
					
					if (var22 * 2 + 1 < var20) {
						this.drawTexturedModalRect(var23, yArmor, 34, 9, 9, 9);
					}

					if (var22 * 2 + 1 == var20 && var20 / 2 >= var22) {
						this.drawTexturedModalRect(var23, yArmor, 25, 9, 9, 9);
					}

					if (var22 * 2 + 1 > var20 && var20 / 2 > var22) {
						this.drawTexturedModalRect(var23, yArmor, 16, 9, 9, 9);
					}
				}
