...
public class RenderItem implements IResourceManagerReloadListener {
	...
	public void func_180454_a(ItemStack p_180454_1_, IBakedModel p_180454_2_) {
		...
		if (p_180454_2_.isBuiltInRenderer()) {
			...
			Item item = p_180454_1_.getItem();
			if (item.haveMesh()) {
				drawCustomMesh(item.getMeshModel());
			} else
	...
	public void drawCustomMesh(MeshModel meshModel) {
		
		if (!meshModel.isLoaded())
			meshModel.loadToOGL();
		...
		GlStateManager.translate(0.03F, 0.0F, -0.05F);
		GlStateManager.rotate(60.0F, -1.0F, 0.0F, 0.0F);
		GlStateManager.rotate(25.0F, 1.0F, 1.0F, 0.0F);
		GlStateManager.rotate(90.0F, 0.0F, 0.0F, -1.0F);*/
		
		GlStateManager.scale(5, 5, 5);
		GlStateManager.translate(0.035F, 0.14F, -0.15F);
		GlStateManager.rotate(90.0F, 0.0F, 0.2F, -1.0F);
